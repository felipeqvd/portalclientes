...
CKEDITOR.editorConfig = function( config ) {
	...
	****************************************/
	...
	//config.enterMode = CKEDITOR.ENTER_BR;					// Cambiado por margin: 0 para los elementos p
	...
	****************************************/
	config.extraPlugins = 'colorbutton,colordialog,liststyle,tableresize,widget,lineutils,widgetselection,footnotes';	//,language';
	...
	config.removePlugins = 'uploadfile,wsc,scayt,format';	// Por ahora quito los estilos pero pueden servir para poner estilos predefinidos
